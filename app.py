...
DEFAULT_API_KEY = "curl "https://generativelanguage.googleapis.com/v1beta/models/gemini-flash-latest:generateContent" \
  -H 'Content-Type: application/json' \
  -H 'X-goog-api-key: AIzaSyD3OE7tIgahmV8MHq_SDGchrldYfBir5pU' \
  -X POST \
  -d '{
    "contents": [
      {
